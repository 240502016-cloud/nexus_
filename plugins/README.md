...
- **`ai_assistant`** — `/sor <soru>` komutu, yerel Ollama sunucusuna (`localhost:11434`,
  model `qwen2.5:7b`) konuşur. **Anthropic/OpenAI gibi ücretli bir API kullanmaz** — internet
  bağlantısı veya API anahtarı gerekmez, token faturası oluşmaz. Kurulum: `ollama pull qwen2.5:7b`
  (bkz. [ollama.com](https://ollama.com)); Ollama servisi ayakta olmalı.
